...
def create_mrak() -> Hero:
    ...
    deck = [
        ...
        Card(
            ...
            primary_action=ActionType.SKILL,
            primary_action_value=None,
            secondary_actions={ActionType.ATTACK: 8, ActionType.DEFENSE: 3, ActionType.MOVEMENT: 7},
            radius_value=4,
        ...
        Card(
            ...
            secondary_actions={ActionType.ATTACK: 6, ActionType.DEFENSE: 7},
        ...
        Card(
            ...
            primary_action=ActionType.SKILL,
            primary_action_value=None,
            secondary_actions={ActionType.ATTACK: 7, ActionType.DEFENSE: 3, ActionType.MOVEMENT: 6},
            radius_value=3,
            effect_id="seismic_slam",
            effect_text="An enemy hero in radius adjacent to terrain, or to a :rock_token: Rock token, discards a card, or is defeated.\n( The secondary Attack action is non-ranged. )",
        ),
        Card(
            id="stone_grip",
            name="Stone Grip",
