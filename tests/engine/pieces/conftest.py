...
`tests/engine/pieces` has no `__init__.py` (project convention: most test dirs
...
Insert the repo root here so `tests` resolves as an implicit namespace
package, without touching the no-`__init__.py` convention for sibling dirs.
"""
