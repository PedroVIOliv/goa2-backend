...
from goa2.engine.steps import FinalizeHeroTurnStep, LogMessageStep, MoveUnitStep, SelectStep
...
class TestMandatoryStepAbort:
    ...
    def test_movement_select_no_valid_destinations_aborts(self, basic_state):
        ...
        """
        from goa2.engine.filters import ObstacleFilter, RangeFilter
        ...
        push_steps(
            ...
            [
                ...
                SelectStep(
                    ...
                    ],  # Note: OccupiedFilter changed param name from require_empty to is_occupied=False
