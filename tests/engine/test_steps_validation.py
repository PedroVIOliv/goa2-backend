...
from goa2.domain.models import Team, TeamColor, Hero, ActiveEffect, EffectType, EffectScope, Shape, AffectsFilter, DurationType, Modifier
...
def test_place_unit_step_blocked_by_effect(game_state_with_heroes):
    ...
    step = PlaceUnitStep(
        unit_id="red_hero",
        target_hex_arg=Hex(q=3, r=-2, s=-1),
        is_mandatory=True
    )
...
def test_move_unit_step_blocked_by_prevention(game_state_with_heroes):
    ...
    state.active_modifiers.append(Modifier(
        id="mod_1", source_id="enemy", target_id="red_hero",
...
def test_push_unit_step_blocked_by_prevention(game_state_with_heroes):
    ...
    state.active_modifiers.append(Modifier(
        id="mod_1", source_id="red_hero", target_id="red_hero",
